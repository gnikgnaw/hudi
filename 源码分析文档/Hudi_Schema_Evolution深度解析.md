...
> 源码路径: `/hudi-common/src/main/java/org/apache/hudi/internal/schema/`
...
源码位置：`TableChanges.ColumnAddChange`
...
private void addColumnsInternal(String parent, String name, Type type, String doc) {
    ...
    // 3. 为新列及其子字段分配 ID（从 maxColumnId + 1 开始）
